...
@section('content')
    <div class="d-flex flex-row justify-content-between">
        <p class="btn btn-primary mt-3">Halaman Show Role</p>
    </div>
    ...
    <div class="my_card">
        ...
        <div class="d-flex gap-4 flex-column flex-md-row">
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('view-petugas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('create-petugas', $permissions) ? 'checked' : '' }}
                        {{ in_array('create-petugas', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="create-petugas">
                    <label for="role">create-petugas</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('edit-petugas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('show-petugas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('delete-petugas', $permissions) ? 'checked' : '' }}
                        {{ in_array('delete-petugas', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('view-makanan', $permissions) ? 'checked' : '' }}
                        {{ in_array('view-makanan', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="view-makanan">
                    <label for="role">view-makanan</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('create-makanan', $permissions) ? 'checked' : '' }}
                        {{ in_array('create-makanan', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="create-makanan">
                    <label for="role">create-makanan</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('edit-makanan', $permissions) ? 'checked' : '' }}
                        {{ in_array('edit-makanan', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="edit-makanan">
                    <label for="role">edit-makanan</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('show-makanan', $permissions) ? 'checked' : '' }}
                        {{ in_array('show-makanan', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="show-makanan">
                    <label for="role">show-makanan</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('delete-makanan', $permissions) ? 'checked' : '' }}
                        {{ in_array('delete-makanan', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="delete-makanan">
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('view-minuman', $permissions) ? 'checked' : '' }}
                        {{ in_array('view-minuman', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="view-minuman">
                    <label for="role">view-minuman</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('create-minuman', $permissions) ? 'checked' : '' }}
                        {{ in_array('create-minuman', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="create-minuman">
                    <label for="role">create-minuman</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('edit-minuman', $permissions) ? 'checked' : '' }}
                        {{ in_array('edit-minuman', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="edit-minuman">
                    <label for="role">edit-minuman</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('show-minuman', $permissions) ? 'checked' : '' }}
                        {{ in_array('show-minuman', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="show-minuman">
                    <label for="role">show-minuman</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('delete-minuman', $permissions) ? 'checked' : '' }}
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('view-fasilitas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('create-fasilitas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('edit-fasilitas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('show-fasilitas', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('delete-fasilitas', $permissions) ? 'checked' : '' }}
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('view-peraturan', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('create-peraturan', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('edit-peraturan', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('delete-peraturan', $permissions) ? 'checked' : '' }}
        ...
        <div class="d-flex gap-4 flex-column flex-md-row">
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('show-userManagement', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false"
                        {{ in_array('delete-userManagement', $permissions) ? 'checked' : '' }}
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('view-role', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('create-role', $permissions) ? 'checked' : '' }}
                        {{ in_array('create-role', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="create-role">
                    <label for="role">create-role</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('edit-role', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('show-role', $permissions) ? 'checked' : '' }}
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('delete-role', $permissions) ? 'checked' : '' }}
                        {{ in_array('delete-role', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="delete-role">
            ...
            <div class="d-flex flex-column lh-1">
                ...
                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('view-audit', $permissions) ? 'checked' : '' }}
                        {{ in_array('view-audit', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="view-audit">
                    <label for="role">view-audit</label>
                </div>

                <div class="form-group">
                    <input type="checkbox" onclick="false" {{ in_array('show-audit', $permissions) ? 'checked' : '' }}
                        {{ in_array('show-audit', $permissions) ? 'checked' : '' }} id="role" name="permission[]"
                        value="show-audit">

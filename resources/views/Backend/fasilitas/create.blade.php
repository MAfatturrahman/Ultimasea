        ...
        <div class="my_card w-75">
            <form method="POST" action="{{ url('fasilitas') }}">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input class="form-control" type="text" name="gambar_fasilitas" placeholder="gambar.jpg" required>
                    </div>
                    ...
                    <div class="col-sm-7">
                        <input class="form-control" type="text" name="status_fasilitas" placeholder="status" required>
                    </div>
